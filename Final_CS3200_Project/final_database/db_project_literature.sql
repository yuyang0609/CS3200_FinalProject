...
CREATE TABLE `literature` (
  ...
  CONSTRAINT `fk_writer` FOREIGN KEY (`writer_id`) REFERENCES `writer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `literature` VALUES (1,'Uncle Tom\'s Cabin','NOVEL',1),(2,'Harry Potter','NOVEL',2),(3,'The Little Prince','NOVEL',3);
...
-- Dump completed on 2021-04-30 20:18:16
